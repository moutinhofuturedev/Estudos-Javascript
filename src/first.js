...
const bands = {
  ...
  punk: 'Ramones',
  hardcore: 'Pennywaise',
  alternative: 'Aerosmith'
}
const optional = bands.punk ? `O punk do ${bands.punk} toca aqui` : bands.metal
console.log(optional)

const chaining = bands.emocore ? 'The Mechanical Romance vai tocar' : `Ouvir ${bands.alternative} é muito melhor`
console.log(chaining)

// VERIFICAÇÃO COM OPTIONAL CHAINING => verficando quando algo não existe com ?
const verification = bands.categorys?.emocore?.bands ? 'Tem banda EMO' : 'Bandas não informadas'
